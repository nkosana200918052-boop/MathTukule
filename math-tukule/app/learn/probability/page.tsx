...
const [questionNumber, setQuestionNumber] = useState(1);
    ...
    <main className="min-h-screen bg-slate-50 px-5 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="mt-3 text-slate-600">
          Learn how to describe the chance that an event will happen.
        </p>
        ...
        <div className="mt-8 rounded-3xl bg-white p-6 shadow-sm">
          ...
          <div className="mt-5 rounded-2xl bg-blue-50 p-5">
            ...
            <p className="mt-2 text-slate-700">
              A bag has 3 red balls and 7 blue balls.
              There are 10 balls altogether.
            </p>

            <p className="mt-2 text-slate-700">
              Probability of choosing a red ball = 3/10
            </p>
          </div>
        </div>
  ...
  <p className="mt-4 text-lg font-semibold text-slate-800">
    {questionNumber === 1
  ? "A bag contains 3 red balls and 7 blue balls. What is the probability of choosing a red ball?"
